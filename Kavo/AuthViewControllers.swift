...
final class EULAViewController: KavoViewController {
    override func viewDidLoad() {
        ...
        let body = UITextView()
        body.text = """
             Welcome to Kavo! To keep our retro community warm, respectful, and safely rooted in good vibes, the following content is strictly prohibited on the platform:
        
        1. Any content involving child sexual abuse material, exploitation, or harm to minors.
        
        2. Fake, misleading, or harmful misinformation regarding current events, civic processes, or public safety.
        
        3. Violence, targeted bullying, harassment, hate speech, and explicit or pornographic content.
        
             If any violations are discovered, the offending content will be promptly removed and your account will be permanently banned.
        By tapping "I agree", you agree to Kavo's Terms of Use and Privacy Policy.
        """
