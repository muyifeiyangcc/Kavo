...
final class BPackageQuickLoginViewController: UIViewController {
    ...
    private func bPackageConfigureUI() {
        ...
        bPackageSignInButton.titleLabel?.font = KavoFont.headline
        bPackageSignInButton.backgroundColor = KavoColor.primary
        bPackageSignInButton.layer.cornerRadius = 12
        bPackageSignInButton.layer.masksToBounds = true
        bPackageSignInButton.layer.borderWidth = 0
        bPackageSignInButton.configuration = nil
        ...
        NSLayoutConstraint.activate([
            ...
            bPackageSignInButton.heightAnchor.constraint(equalToConstant: 52),
